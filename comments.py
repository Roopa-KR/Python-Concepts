...
# In the example above, the print statement is commented out, so it will not be executed when you run the program. This can be useful for testing or debugging your code without deleting it.

#Multi-line Comments
# If you want to write a comment that spans multiple lines, you can use triple quotes (
# ''' or """) to create a multi-line comment:
'''
